            ...
            <form>
              <div className="flex  flex-wrap gap-y-5 flex-col changeformtag">
                <select
                  ...
                  className="w-2/3  p-3  border-[2px] border-black rounded-md  bg-white text-black"
                >
                ...
                <select
                  name="semester"
                  className=" w-1/2 sm:w-1/3 p-3   border-black   border-[2px] rounded-md bg-white text-black"
                ...
                <select
                  name="subject"
                  className=" w-1/3 sm:w-1/4 p-3   border-black   border-[2px] rounded-md  bg-white text-black"
